...
// Variables
$directorio = 'C:/Users/Consuelo/Desktop/startbootstrap-sb-admin-2-gh-pages/pages/';
...
$nombre = isset($_POST['Ingrese Nombre']) ? Filtro($_POST['nombre']) : '';
...
?>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <p>
        Tu <b><?php echo ($terminos == 1 ? 'sí' : 'no'); ?></b> ¿recibir encuestas a la semana?.</b>
      </p>
    </div>
...
<?php } ?>
  ...
  <footer>
    <div class="text-center">
      ...
      Desarrollado por <a href="https://github.com/MiguelGonzalezAravena" target="_blank">NN</a>
    </div>
  </footer>
</div>
</body>
